            ...
            <form action="{{ route('publications.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                        class="w-full p-3 rounded-lg bg-white border border-neutral-300 text-neutral-800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-amber-500 transition shadow-sm"></textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="publication_date" name="publication_date"
                        ...
                        -800 placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-amber-500 transition shadow-sm">
                </div>
                ...
                <div>
                    ...
                    <input type="file" id="image_file" name="image_file" accept="image/*" required
                        class="w-full p-3 rounded-lg bg-white border border-neutral-300 text-neutral-800 focus:outline-none focus:ring-2 focus:ring-amber-500 transition shadow-sm">
                </div>
